    ...
    public void init() {
        ...
        Router router = new Router(new Router.Render() {
            ...
            public boolean render(Context context, Uri uri) {
                Toast.makeText(context, uri.toString() + "*****default*****base", Toast.LENGTH_SHORT).show();
                return true;
            }
        });

        Dns.register("shanks.uri", router);
        router.addRouterDir("/base", new Router.Render() {
            @Override
            public boolean render(Context context, Uri uri) {
                Toast.makeText(context, uri.toString() + "-----default-----base", Toast.LENGTH_SHORT).show();
                return true;
        ...
        router.addRouter("/base/main", new Router.Render() {
            @Override
            public boolean render(Context context, Uri uri) {
